...
const SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      "Delivery is free on orders above ₹500. Below that a standard fee applies, and express dispatch carries a higher fee. Every charge is itemised before you pay.",
    ],
  },
  {
